...
// Two-step password reset, mirroring the signup verify flow:
//   1. 'email'  — enter address, server emails a 6-digit code (1 min TTL).
//   2. 'reset'  — enter code + new password (same strength rules as signup).
// On success the server returns a fresh token so the user is logged in
// immediately and we send them straight to /scan.
